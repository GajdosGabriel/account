...
return [
    ...
    */
    ...
    |
    | Pozor: 'local' tu nie je verejný ako v Evente. Ukladajú sa sem faktúry
    | (INVOICE_DISK), tie sa vydávajú cez kontrolér so zámkom, nie odkazom.
    |
    */
    ...
    'disks' => [
        ...
        's3' => [
            ...
            // cesty sú odvodené od ID modelu (invoices/2026/...), ktoré sa v oboch
