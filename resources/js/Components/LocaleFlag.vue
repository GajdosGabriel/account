...
/**
 * Vlajka jazyka rozhrania.
 *
 * Zjednodušené kresby v spoločnom viewBoxe 640x480 – v navigácii sa kreslia
 * na 20 px, kde by sa heraldické detaily aj tak stratili. Inline SVG, nie
 * emoji: vlajkové emoji Windows nevykresľuje. Angličtinu zastupuje britská
 * vlajka, tak ako v bežných prepínačoch jazyka.
 */
...
const shapes = computed(() => FLAGS[props.code] ?? []);
</script>
